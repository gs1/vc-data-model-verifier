...
export const DATA_CREDENTIAL = "DataCredential";
export const GS1_IDENTIFICATION_KEY_LICENSE_CREDENTIAL = "GS1IdentificationKeyLicenseCredential";
// NEW CREDENTIAL TYPES FROM GS1 DIGITAL LICENSES SPECIFICATION
export const GS1_8_PREFIX_LICENSE_CREDENTIAL = "GS18PrefixLicenseCredential";
export const DELEGATED_GS1_PREFIX_LICENSE_CREDENTIAL = "DelegatedGS1PrefixLicenseCredential";
export const DELEGATED_GS1_IDENTIFICATION_KEY_LICENSE_CREDENTIAL = "DelegatedGS1IdentificationKeyLicenseCredential";
...
const GS1CredentialTypes = [
    ...
    GS1_8_PREFIX_LICENSE_CREDENTIAL,
    DELEGATED_GS1_PREFIX_LICENSE_CREDENTIAL,
    DELEGATED_GS1_IDENTIFICATION_KEY_LICENSE_CREDENTIAL
];
...
const GS1CredentialSchema = [
    ...
    { name: DATA_CREDENTIAL, schemaId: "https://id.gs1.org/vc/schema/v1/data" },
    ...
    // NEW SCHEMA MAPPINGS
    { name: GS1_8_PREFIX_LICENSE_CREDENTIAL, schemaId: "https://id.gs1.org/vc/schema/v1/prefix8" },
    { name: DELEGATED_GS1_PREFIX_LICENSE_CREDENTIAL, schemaId: "https://id.gs1.org/vc/schema/v1/delegated-prefix" },
    { name: DELEGATED_GS1_IDENTIFICATION_KEY_LICENSE_CREDENTIAL, schemaId: "https://id.gs1.org/vc/schema/v1/delegated-idkey" }
];
...
export const getCredentialRuleSchemaChain = function(credential: VerifiableCredential) : gs1CredentialSchemaChain { 
    ...
    switch(credentialType.name) {
        ...
        // NEW CREDENTIAL TYPE CASES
        case GS1_8_PREFIX_LICENSE_CREDENTIAL:
            return gs1CredentialChainRules.GS18PrefixLicenseCredential;
        case DELEGATED_GS1_PREFIX_LICENSE_CREDENTIAL:
            return gs1CredentialChainRules.DelegatedGS1PrefixLicenseCredential;
        case DELEGATED_GS1_IDENTIFICATION_KEY_LICENSE_CREDENTIAL:
            return gs1CredentialChainRules.DelegatedGS1IdentificationKeyLicenseCredential;
        default:
