...
const verifiable_credentials_1 = require("@transmute/verifiable-credentials");
const resolver_1 = require("./resolver");
// Create a single validator instance with resolver
const credentialValidator = (0, verifiable_credentials_1.validator)({ resolver: resolver_1.resolverNoCache });
// Export a reusable validation function
async function validateCredential(jwtVc) {
