...
function splitJwt(jwt) {
    ...
    const header = JSON.parse(base64url_1.default.decode(headerB64));
...
//   const { header, payload, signature } = splitJwt(jwtVc);
