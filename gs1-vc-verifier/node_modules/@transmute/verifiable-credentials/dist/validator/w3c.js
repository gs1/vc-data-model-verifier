...
const isPointerToIdentifier = (pointer) => {
...
const identifiers = (result, pointer, value) => {
...
const issuer = (result, pointer, value) => {
...
const holder = (result, pointer, value) => {
...
// https://www.w3.org/TR/vc-data-model-2.0/#presentations-0
const verifiableCredential = (result, pointer, value) => {
    var _a;
    const nonObjectPointer = pointer === null || pointer === void 0 ? void 0 : pointer.split('/verifiableCredential/').pop();
    ...
    const pointerIndex = (_a = pointer === null || pointer === void 0 ? void 0 : pointer.split('/verifiableCredential/').pop()) === null || _a === void 0 ? void 0 : _a.split("/")[0];
...
const types = (result, pointer, value) => {
...
const names_and_descriptions = (result, pointer, value) => {
...
const conformance = (result) => {
    const dict = json_pointer_1.default.dict(result.content);
